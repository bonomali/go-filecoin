...
// Print writes with fmt.Print and returns true if there was no error.
...
// Print writes with fmt.Println and returns true if there was no error.
...
// Print writes with fmt.Printf and returns true if there was no error.
